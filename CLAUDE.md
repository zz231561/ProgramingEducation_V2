...
**🎯 進行中：Phase 2 — 下一任務：2-3a 精熟度 schema (`student_mastery` 表)**
...
- 🟡 2-4 智慧出題：2-4a ✅（questions + student_answers schema）→ **下一步 2-4b**（Select 階段：弱項概念選取 + 知識圖譜關聯）｜ 2-4c Generate ｜ 2-4d Validate ｜ 2-4e API
- ⬜ 2-5/2-6 反思
