...
- **🎯 Phase 6 進行中**（NotebookLM grounded 教學內容建構）
  ...
  - 後端 608 tests 全綠（2026-07-06 6-M1 +3）；實機 LLM 全跑延至 6-4 合併執行
...
- **執行順序 10 批已定案**（2026-07-06，詳見 roadmap 已確認決策）：①~④ ✅ + ⑤ 6-M1 ✅ → ⑤ 實機批次（6-3a-3 + 6-4a + deferred-ui + K4d 調參，需 OpenAI 儲值 $10）→ ⑥ U2f → ⑦ 教師端 → ⑧ U2e+監控 → ⑨ Phase 7 → ⑩ 5-3/5-4；真人驗收改使用者自測；**下一步：第 5 批實機批次**
