...
- **🎯 Phase 6-K K-Graph 自適應學習引擎**（2026-07-04 功能規格書新增；原 6-5/6-6 整併入 K4 / K1+K5）
  ...
  - K5a/b/c ✅（2026-07-05，三輪迭代）：維持 Cytoscape.js + mastery band 填色 + 路徑 ring（藍=目前/綠=已完成/紅=補救 `?remedial=`）+ **太陽系主題**（十章=太陽→冥王星 NASA 影像 `public/planets/`、蛇形軌道 preset 佈局、軌道線/星空 underlay、進度星球聚焦 + GalaxyNav、zoom cap 1.0、跨章邊淡出）
