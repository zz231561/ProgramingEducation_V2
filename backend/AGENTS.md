...
- route 的 request/response/status/auth 變更同步 `docs/api-spec.md`；ORM/migration 變更同步 `docs/db-schema.md`；Settings 變更同步 `backend/.env.example`，最後跑 `python3 scripts/doc_selfcheck.py`
