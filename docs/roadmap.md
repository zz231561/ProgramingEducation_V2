...
- [ ] 7-E8 **安全與設定**
- [ ] 7-E9 **持續回饋與新功能盤點**：確認問題分流、回歸方式，並依驗收回饋產出後續新功能清單
...
- [ ] 8-2c **死程式碼與孤兒檔案盤點**：只提出清單與處置建議，不自行刪除；tech-debt
      C3／C6／B5 已有歸屬，不重複處理
...
- [ ] 7-3c **Runner production latency**：只量測 Zeabur A→B production end-to-end latency
